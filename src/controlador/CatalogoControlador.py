class CatalogoControlador:
    ...
    def __init__(self, ref_modelo, ref_vista, correo_usuario=None, tipo_usuario=None):
    ...
    def cargarCatalogo(self):
        ...
        self._vista.mostrarLibros(libros)
    ...
    def reservarLibro(self, isbn):
        if not self._correo_usuario:
            self._vista.lanzarAviso("No hay usuario identificado.")
            return
        ...
        if exito:
            self._vista.lanzarAviso("Reserva realizada con éxito.")
            self.cargarCatalogo()
        else:
            self._vista.lanzarAviso(
    ...
    def bajaLibro(self, isbn):
        ...
        if exito:
            self._vista.lanzarAviso("Libro retirado del catálogo.")
            self.cargarCatalogo()
        else:
            self._vista.lanzarAviso(
